...
Guía para agentes de IA que trabajan en este repositorio. Comparte el mismo
contenido base que [`CLAUDE.md`](./CLAUDE.md); si actualizas uno, actualiza el
otro para mantenerlos sincronizados.
...
└── data/                       # reglas en JSON (wheelRulesSingle / wheelRulesMixed)
```
...
- Componentes en **PascalCase** (`.jsx`); utilidades en **camelCase** (`.js`).
